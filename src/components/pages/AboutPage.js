...
const AboutPage = () => {
  return (
    <div className='container mt-4'>
      <h2 className='d-flex justify-content-center'><span>About</span></h2>
      <img src="https://purepng.com/public/uploads/large/musician-band-025.png" alt="music band" className='float-start me-3 mb-3'  style={{ width: '400px', height: 'auto' }} />
